...
api.add_resource(ListBucketlist, "/bucketlists/<bucket_id>",
                 endpoint="modifyspecificbucketlist")

# Create a new bucket item for a specific bucket 	POST
api.add_resource(
    BucketListItem, "/bucketlists/<bucket_id>/items", endpoint="createnewbucketitem")

# Edit the content of a specific bucket item 		PUT
# Delete an existing bucketlist item 				DELETE
api.add_resource(ListBucketlistItem, "/bucketlists/<bucket_id>/items/<item_id>",
                 endpoint="modifyspecificbucketlistitem")
